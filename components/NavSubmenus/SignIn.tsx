  ...
  return (
    <div className={`lg:bg-white text-black absolute lg:fixed top-20 lg:right-64 lg:px-8 ${styles["right-signin"]} mt-6 pr-8`}>
      ...
      <form className="mt-2" onSubmit={this.validateEmail}>
        ...
        <input id="email" type="email" className={`rounded	block w-full py-1.5 px-3 font-normal text-base text-black bg-white bg-clip-padding mt-2 ${styles["border-signin"]} h-8 `}placeholder="Email Address"></input>
      ...
      <a data-click-id="global_primary_nav_button_signin" href="https://help.webex.com/en-us/n5q6x5j/Sign-In-Issues-with-Webex" target="_blank" className="text-blue inline-block text-sm text-normal">Contact
                        Support</a>
      </p>
    </div>
